...
\t\t\t\t</p>
\t\t\t\t<h3 class=\"fs-base fw-normal text-body text-uppercase pb-2 pb-sm-3\">2.<span class=\"text-decoration-underline ms-1\">Choisir une autre adresse de facturation</span>
\t\t\t\t</h3>
\t\t\t\t";
        // line 18
        echo twig_replace_filter($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "adresse", [], "any", false, false, false, 18), 'row'), ["[-br]" => "<br/>"]);
        echo "
\t\t\t\t
\t\t\t</div>
...
\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["recapCart"]) || array_key_exists("recapCart", $context) ? $context["recapCart"] : (function () { throw new RuntimeError('Variable "recapCart" does not exist.', 29, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["formedeboxe"]) {
            // line 30
            $context["total"] = ((isset($context["total"]) || array_key_exists("total", $context) ? $context["total"] : (function () { throw new RuntimeError('Variable "total" does not exist.', 30, $this->source); })()) + twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["formedeboxe"], "formedeboxe", [], "any", false, false, false, 30), "prix", [], "any", false, false, false, 30));
            // line 31
            echo "\t\t\t\t
...
\t\t\t\t\t\t\t<img src=\"/image/";
            // line 35
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["formedeboxe"], "formedeboxe", [], "any", false, false, false, 35), "photo", [], "any", false, false, false, 35), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 40
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["formedeboxe"], "formedeboxe", [], "any", false, false, false, 40), "nom", [], "any", false, false, false, 40), "html", null, true);
            echo "</a>
\t\t\t\t\t\t\t\t\t\t</h3>
\t\t\t\t\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t\t\t\t\t";
            // line 43
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["formedeboxe"], "formedeboxe", [], "any", false, false, false, 43), "description", [], "any", false, false, false, 43), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div>
<p class=\"mb-2\"> Prix du formedeboxe :";
            // line 47
            echo twig_escape_filter($this->env, twig_number_format_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["formedeboxe"], "formedeboxe", [], "any", false, false, false, 47), "prix", [], "any", false, false, false, 47), 2, ",", "."), "html", null, true);
            echo "€</p>
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t<a class=\"nav-link fs-xl p-2\" href=\"";
            // line 53
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("cart_remove", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["formedeboxe"], "formedeboxe", [], "any", false, false, false, 53), "id", [], "any", false, false, false, 53)]), "html", null, true);
...
\t\t\t\t\t\t<span class=\"fs-3 fw-semibold text-dark ms-2\">";
        // line 63
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (isset($context["total"]) || array_key_exists("total", $context) ? $context["total"] : (function () { throw new RuntimeError('Variable "total" does not exist.', 63, $this->source); })()), 2, ",", "."), "html", null, true);
        echo "
\t\t\t\t\t\t\t€</span>
\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  204 => 74,  190 => 63,  185 => 60,  172 => 53,  163 => 47,  156 => 43,  150 => 40,  140 => 35,  134 => 31,  132 => 30,  127 => 29,  125 => 28,  118 => 24,  115 => 23,  108 => 18,  101 => 14,  94 => 10,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
