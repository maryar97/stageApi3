    ...
    <div class=\"row align-items-start \">
     ...
     <div class=\"card-body\"> <div class=\"row align-items-center\">
       ...
       <div class=\"col-4\" ></div>
          <h5 class=\"card-title\">";
            // line 14
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forme3"], "nom", [], "any", false, false, false, 14), "html", null, true);
            echo "</h5>
          <p class=\"card-text\">";
            // line 15
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forme3"], "description", [], "any", false, false, false, 15), "html", null, true);
            echo "</p>
          <p class=\"card-text\">Prix :";
            // line 16
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forme3"], "prix", [], "any", false, false, false, 16), "html", null, true);
            echo "€</p>
          <button type=\"button\" class=\"btn btn-light\" li class=\"nav-item\">
                    ";
            // line 18
            if ((twig_get_attribute($this->env, $this->source, $context["forme3"], "prix", [], "any", false, false, false, 18) > 0)) {
                // line 19
                echo "\t\t\t\t\t<a href=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("cart_add", ["id" => twig_get_attribute($this->env, $this->source, $context["forme3"], "id", [], "any", false, false, false, 19)]), "html", null, true);
...
";
    ...
    {
        return array (  136 => 25,  130 => 22,  127 => 21,  121 => 19,  119 => 18,  114 => 16,  110 => 15,  106 => 14,  101 => 12,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"card mb-3 \" with=\"auto\">
     <div class=\"card-body\"> <div class=\"row align-items-center\">
       ...
       <div class=\"col-4\" ></div>
          ...
          <button type=\"button\" class=\"btn btn-light\" li class=\"nav-item\">
                    {% if forme3.prix > 0 %}
\t\t\t\t\t<a href=\"{{path('cart_add',{'id':forme3.id})}}\" class=\"btn btn-dark\">Prendre ma licence</a> 
                {% endif %}
                {% if forme3.prix < 0  %}
